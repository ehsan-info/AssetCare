...
export const PurchaseOrderCategoryPanel = () => {
  const [purchaseOrdersCategories, setPurchaseOrdersCategories] = useState(
    purchaseOrdersCategoriesData
  );
  ...
  const onDeletePurchaseOrderCategory = id => {
    ...
    setIsSuccess(true);
    setSaveSent(true);
    setPurchaseOrdersCategories(purchaseOrdersCategories.filter(e => e.id !== parseInt(id)));
  };
